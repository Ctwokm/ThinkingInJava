...
/*
 * Output: Beginning of main() ********* Creation of MyClassA Creation of
 * MyClassB Creation of MyClassC Creation of MyClassA Creation of MyClassB
 * Creation of MyClassC End of main() ********* MyClassB.run() MyClassA.run()
 * MyClassC.run() MyClassB.run() MyClassA.run() MyClassC.run() MyClassB.run()
 * MyClassA.run() MyClassC.run() Task from MyClassB completed Task from MyClassA
 * completed Task from MyClassC completed MyClassA.run() MyClassA.run()
 * MyClassA.run() Task from MyClassA completed MyClassC.run() MyClassC.run()
 * MyClassC.run() Task from MyClassC completed MyClassB.run() MyClassB.run()
 * MyClassB.run() Task from MyClassB completed
 */